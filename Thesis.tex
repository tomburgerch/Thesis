...
% We will concentrate on the first two in our experiments as they have proven to be most successful and most popular in earlier work.
...
The new component was released to production on March 4th, 2013, beginning of calendar week 10. At the same time, the old component was discontinued. Every new user was automatically checked during the sign-up process. In addition to that, Business Officers and Owners were checked manually through SOAP by the Operations Team.

Chart \ref{fig:pep-hra-charts}
...
\begin{figure}
        ...
        \caption{Different types of HMMs (from top left to bottom right): LTR HMM where skipping of states is not allowed, LRM with skipping of one step, LRM with allowed skipping, Parallel HMM, Ergodic HMM}
        \label{fig:pep-hra-charts}
\end{figure}


Number of PEP/Sanction Hits (need review by ops)
December:  283
January: 463
February: 853
March:125
...
Note: If changes hadn't been implemented, man hours would significantly increase in line with increase in sign ups.

December:  10 hours
January: 16 hours
February: 29 hours
March:4 hours
April to Date: 0. 3 hours


Positive Hits -  40
Unable to discount due to lack of information on merchant account - further docs requested : 170
False Positive - 1523

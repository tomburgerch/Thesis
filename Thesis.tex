...
\supervisors{Christian Decker\\Conor Wogan (SumUp)\\[2pt] Prof.\ Dr.\ Roger Wattenhofer}

% You can comment the following two commands if you don't need them
\keywords{Fraud Detection, Signature Verification, Fraud Detection, Mobile Payments, Mobile Devices}
...
\fnurl{iZettle}{http://www.izettle.com}, \fnurl{Square}{http://www.squareup.com}, \fnurl{SumUp}{http://www.sumup.com} are just some of the companies which make use of this situation and are enabling merchants to receive payments via their smartphone. This thesis was written in collaboration with SumUp, a mobile payment company located in Berlin. % and Dublin.
%In Section \ref{intro-sumup} SumUp's business model is explained in more detail.
...
% Payment through SumUp gives taxi drivers, market traders and artisans in particular an enormous economic advantage, in that mobile payments can now be processed right on the spot. Customers no longer have to be turned away, as any service can be billed immediately. Other areas of industry such as personal grooming, beauty salons, bakeries and boutiques can also benefit from the mobile payment method. Traditional card terminals are often associated with high investment and operating costs. SumUp, however, provides its services to retailers free of charge while working with transparent pricing structures and a straightforward Terms of Service. SumUp only places a single low fee of 2.75 percent on any successful transaction. There are no additional costs.
